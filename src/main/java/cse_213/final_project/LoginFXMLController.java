...
//        }
    ...
    public void loginOA(ActionEvent actionEvent) throws IOException {
        ...
        if ((UsertypeCB.getValue().equals("Liaison Officer"))){
            SceneSwitcher.switchTo("Fima/LiaisonOfficer/LiaisonOfficer_Dashboard_V2.fxml");
        }
        if ((UsertypeCB.getValue().equals("Toll booth operator"))){
            SceneSwitcher.switchTo("Fima/TollBoothOperator/TollBoothOperator_Dashboard_V1.fxml");
        }
